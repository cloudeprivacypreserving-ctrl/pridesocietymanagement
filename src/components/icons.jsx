// Shared icon set — outline style, 1.8 stroke, 24x24 viewBox, matching
// the icons already used in Layout/Dashboard/ResidentCard/ResidentForm.
// Centralized here instead of redefined per file.
